...
@section('title', 'إضافة مهندس جديد')
...
@endif
    <form action="{{ route('engineers.store') }}" method="POST" enctype="multipart/form-data" id="wizardForm">
        @csrf
        ...
        <div class="wizard-content">
            ...
            <div class="step-content active" data-step="1">
                ...
                <div class="image-upload-wrapper">
                    ...
                    <label class="image-upload" for="personal_image_input">
                        ...
                        <div>انقر لرفع الصورة الشخصية</div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="second_name" class="form-control @error('second_name') is-invalid @enderror" value="{{ old('second_name') }}" required>
                        @error('second_name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="third_name" class="form-control @error('third_name') is-invalid @enderror" value="{{ old('third_name') }}" required>
                        @error('third_name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="mobile_1" class="form-control @error('mobile_1') is-invalid @enderror" value="{{ old('mobile_1') }}" required>
                        @error('mobile_1')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mobile_2" class="form-control @error('mobile_2') is-invalid @enderror" value="{{ old('mobile_2') }}">
                        @error('mobile_2')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>العمر</label>
                        <div class="age-display" id="ageDisplay">قم بإدخال تاريخ الميلاد</div>
                    </div>
                </div>
            </div>
            ...
            <div class="step-content" data-step="2">
                    ...
                    <div class="form-group">
                        ...
                        <select name="home_governorate_id" id="home_governorate_id" class="form-control @error('home_governorate_id') is-invalid @enderror" required>
                            ...
                            @foreach($governorates as $gov)
                                <option value="{{ $gov->id }}" {{ old('home_governorate_id') == $gov->id ? 'selected' : '' }}>
                                    {{ $gov->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <textarea name="home_address_details" class="form-control @error('home_address_details') is-invalid @enderror" rows="3">{{ old('home_address_details') }}</textarea>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="work_governorate_id" id="work_governorate_id" class="form-control @error('work_governorate_id') is-invalid @enderror" required>
                            <option value="">اختر المحافظة</option>
                            @foreach($governorates as $gov)
                                <option value="{{ $gov->id }}" {{ old('work_governorate_id') == $gov->id ? 'selected' : '' }}>
                                    {{ $gov->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <textarea name="work_address_details" class="form-control @error('work_address_details') is-invalid @enderror" rows="3">{{ old('work_address_details') }}</textarea>
            ...
            <div class="step-content" data-step="3">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="salary_amount" class="form-control @error('salary_amount') is-invalid @enderror" value="{{ old('salary_amount') }}" min="0" required>
                        @error('salary_amount')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="salary_currency_id" class="form-control @error('salary_currency_id') is-invalid @enderror" required>
                            ...
                            @foreach($currencies as $currency)
                                <option value="{{ $currency->id }}" {{ old('salary_currency_id') == $currency->id ? 'selected' : '' }}>
                                    {{ $currency->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="work_start_date" class="form-control @error('work_start_date') is-invalid @enderror" value="{{ old('work_start_date') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="work_end_date" class="form-control @error('work_end_date') is-invalid @enderror" value="{{ old('work_end_date') }}">
                        @error('work_end_date')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="step-content" data-step="4">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="app_username" class="form-control @error('app_username') is-invalid @enderror" value="{{ old('app_username') }}">
                        @error('app_username')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="app_password" class="form-control @error('app_password') is-invalid @enderror">
                        @error('app_password')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_type" class="form-control @error('phone_type') is-invalid @enderror" value="{{ old('phone_type') }}" placeholder="مثال: Android, iOS">
                        @error('phone_type')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_name" class="form-control @error('phone_name') is-invalid @enderror" value="{{ old('phone_name') }}" placeholder="مثال: Samsung Galaxy">
                        @error('phone_name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="os_version" class="form-control @error('os_version') is-invalid @enderror" value="{{ old('os_version') }}" placeholder="مثال: Android 12">
                        @error('os_version')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="step-content" data-step="5">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="bank_name" class="form-control @error('bank_name') is-invalid @enderror" value="{{ old('bank_name', 'بنك فلسطين') }}">
                        @error('bank_name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="iban_number" class="form-control @error('iban_number') is-invalid @enderror" value="{{ old('iban_number') }}">
                        @error('iban_number')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="account_owner_first" class="form-control @error('account_owner_first') is-invalid @enderror" value="{{ old('account_owner_first') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account_owner_second" class="form-control @error('account_owner_second') is-invalid @enderror" value="{{ old('account_owner_second') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account_owner_third" class="form-control @error('account_owner_third') is-invalid @enderror" value="{{ old('account_owner_third') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account_owner_last" class="form-control @error('account_owner_last') is-invalid @enderror" value="{{ old('account_owner_last') }}">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="account_owner_national_id" class="form-control @error('account_owner_national_id') is-invalid @enderror" value="{{ old('account_owner_national_id') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account_owner_mobile" class="form-control @error('account_owner_mobile') is-invalid @enderror" value="{{ old('account_owner_mobile') }}">
    ...
    const attachmentHTML = `
        <div class="attachment-item" data-index="${attachmentIndex}">
            <div class="attachment-item-header">
                <h4 style="margin: 0; color: #0C4079;">مرفق ${attachmentIndex}</h4>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="attachments[${attachmentIndex}][type_id]" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <textarea name="attachments[${attachmentIndex}][details]" class="form-control" rows="3" placeholder="أدخل تفاصيل إضافية عن المرفق"></textarea>
            </div>
            
            <div class="form-group">
                <label class="required">رفع الملف</label>
                <input type="file" name="attachments[${attachmentIndex}][file]" class="form-control" required>
